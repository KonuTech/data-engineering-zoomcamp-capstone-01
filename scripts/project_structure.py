...
def print_project_structure(root_dir, indent=''):
    ...
    exclude_dirs = ['.git', '.venv', '__pycache__', 'logs']  # Add more directories here as needed
...
# Example usage:
print_project_structure(r"C:\\Users\\KonuTech\\projects\\data-engineering-zoomcamp-capstone-01\\")
